...
const createThreeUserTeam = async (team) => {
    try {
        ...
        const member3Id = await member_id(team[13].toLowerCase().trim());
        const query_2 = "INSERT INTO Teams (TeamId, TeamName, TeamMember_1, TeamMember_2, TeamMember_3, NumOfMembers) VALUES (?, ?, ?, ?, ?, ?)";
        const values_2 = [teamId, teamName, member1Id, member2Id, member3Id, noMembers];
...
export default createThreeUserTeam;